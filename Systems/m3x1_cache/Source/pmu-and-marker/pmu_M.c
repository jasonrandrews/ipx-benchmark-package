...
void start_dwt() {
  ...
  CM_DWT_CONTROL |= CM_DWT_CPIEVTENA_BIT;
  CM_DWT_CONTROL |= CM_DWT_EXCEVTENA_BIT;
  CM_DWT_CONTROL |= CM_DWT_SLEEPEVTENA_BIT;
  CM_DWT_CONTROL |= CM_DWT_LUSEVTENA_BIT;
  CM_DWT_CONTROL |= CM_DWT_FOLDEVTENA_BIT;
}
void stop_dwt() {
  CM_DWT_CONTROL &= ~CM_DWT_CYCCNTENA_BIT;
  CM_DWT_CONTROL &= ~CM_DWT_CPIEVTENA_BIT;
