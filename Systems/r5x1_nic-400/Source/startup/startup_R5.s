...
//----------------------------------------------------------------
    ...
    #define HEAP_BASE Image$$ARM_LIB_STACKHEAP$$Base
    #define CODE_BASE Image$$CODE$$Base
    #define DATA_BASE Image$$DATA$$Base
#elif defined (__GNUC__)                                     // GCC
    #define STACK_TOP stack_top                                         // Define unified variable between compilers
    #define HEAP_BASE __HeapBase
    #define CODE_BASE __code_base
    #define DATA_BASE __data_base
#endif
...
//----------------------------------------------------------------
        ...
        .global   STACK_TOP             // Image$$ARM_LIB_STACKHEAP$$ZI$$Limit
        LDR SP, = STACK_TOP             // Image$$ARM_LIB_STACKHEAP$$ZI$$Limit
...
// Region 4: Peripherals   Base = 0xA8000000   Limit = 0xAFFFFFC0  Device   Full access  Not Executable
...
//----------------------------------------------------------------
    ...
    .global     submain                      // used to be .global __main
        B       submain                      // used to be B __main
