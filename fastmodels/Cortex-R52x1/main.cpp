/*
 * main.cpp - Example Cortex-R52 system with SystemC peripheral
 *
...
int sc_main(int argc , char * argv[]) {
     ...
     */
    scx::scx_initialize("r52x1");

    /*
     * Components
     */
    scx_evs_r52x1  r52x1("r52x1");
     ...
     * Bindings
     */
    r52x1.amba_pv_m(amba2tlm.amba_pv_s);
