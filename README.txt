...
./benchmark-package/license_terms/*       Directory containing Arm and third party license files
...
applications as an example. There are a handful of applications that can not be built
using the files provided in this package, however they have been pre-built for the
systems they support. These are indicated below.
...
which applications are pre-built.
...
When uploading a modified package contianing your custom application, the top level
directory must remain as: benchmark-package
...
> benchmark-package/build_app.sh <application> <system> <compiler>
...
benchmark-package/Systems/<system>/<application>/<compiler>/ directory.
...
Step 1: Modify the "software_name", "software_description" and "valid_systems" tags in
the sw_options.json file. The "software_name" tag value should have the name of all
applications you'd like to upload. For example: "software_name": ["myapp1", "myapp2"].
The "valid_systems" tag value should have the system names you want to run your custom
software on. For example: "valid_systems": ["m0px1_cache", "m7x1_nic-400_nofpu"]. Save
...
user defined code here" and "End user defined code here" and save changes. If other files
or build options are required, please make sure to update the Makefile at
Applications/myapp1/Makefile appropriately.

Step 4(Optional): You can compile your custom software (myapp1) either locally on your
...
Step 5: Run the python script app_checker.py to verify the contents of the
...
Step 6: When your package is ready, you can tar up your top-level directory and create
    the upload package using:
        > tar cvzf custom-software.tgz benchmark-package/

Step 7: You're now ready to upload your tar'd up custom software package.
